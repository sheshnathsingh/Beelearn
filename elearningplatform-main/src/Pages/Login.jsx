    ...
    <div className="flex justify-center items-center h-screen bg-gray-100">
      ...
      >
        ...
        <form className="mt-6" onSubmit={handleSubmit}>
          ...
          <button 
            type="submit" 
            className="w-full mt-6 bg-teal-500 text-white py-2 rounded-lg hover:bg-teal-600 transition-all"
          >
            Log In
          </button>
        </form>
        <p className="text-center mt-4">Don't have an account? <span className="text-teal-500 cursor-pointer" onClick={() => navigate("/signup")}>Sign Up</span></p>
      </motion.div>
    </div>
  );
}
